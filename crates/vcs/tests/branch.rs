...
fn a_branch_holding_commits_of_its_own_is_deleted_too() {
    ...
    GitRunner::new()
        ...
        .expect("delete means delete; whether git considers it merged is not asked");
